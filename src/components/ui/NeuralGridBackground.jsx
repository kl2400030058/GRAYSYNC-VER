...
export default function NeuralGridBackground() {
  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-0 select-none bg-[#080A0F]">
      <style>{`
        /* Layer 1: Infinite Perspective Grid scrolling */
        @keyframes perspective-scroll {
          0% { background-position: 0 0; }
          100% { background-position: 0 64px; }
        }
        
        .tron-perspective-container {
          perspective: 350px;
        ...
        .tron-grid-floor {
          ...
          animation: perspective-scroll 16s linear infinite;
        }

        /* Synaptic signal propagation animation */
        ...
        /* Node aura pulse keyframes */
        @keyframes node-aurora {
        ...
        .node-pulse-s {
          ...
          animation: node-aurora 7s ease-in-out infinite;
        }

        /* Vertical data light pillars */
        @keyframes beam-breath {
          0%, 100% { opacity: 0.02; height: 35%; }
          50% { opacity: 0.12; height: 75%; }
        }

        .light-beam-cyan {
          animation: beam-breath 8s ease-in-out infinite;
        }

        .light-beam-white {
          animation: beam-breath 11s ease-in-out infinite;
        }
        ...
        @media (prefers-reduced-motion: reduce) {
          ...
          .light-beam-cyan, .light-beam-white {
            animation: none !important;
